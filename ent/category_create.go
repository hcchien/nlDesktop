...
func (_c *CategoryCreate) SetSectionID(id int) *CategoryCreate {
...
func (_c *CategoryCreate) SetNillableSectionID(id *int) *CategoryCreate {
	if id != nil {
...
func (_c *CategoryCreate) SetSection(v *Section) *CategoryCreate {
	return _c.SetSectionID(v.ID)
}

// AddPostIDs adds the "posts" edge to the Post entity by IDs.
func (_c *CategoryCreate) AddPostIDs(ids ...int) *CategoryCreate {
...
func (_c *CategoryCreate) createSpec() (*Category, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.SectionIDs(); len(nodes) > 0 {
		...
		_node.category_section = &nodes[0]
