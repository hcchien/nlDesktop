...
type PostQuery struct {
	...
	withHeroImage         *PhotoQuery
	withRelatedPosts      *PostQuery
	withSection           *SectionQuery
	withTags              *TagQuery
	withWriters           *AuthorQuery
	withCreatedBy         *UserQuery
	withFKs               bool
	modifiers             []func(*sql.Selector)
	loadTotal             []func(context.Context, []*Post) error
	withNamedCategories   map[string]*CategoryQuery
	withNamedRelatedPosts map[string]*PostQuery
	withNamedTags         map[string]*TagQuery
	withNamedWriters      map[string]*AuthorQuery
...
func (_q *PostQuery) QueryCategories() *CategoryQuery {
...
// QueryHeroImage chains the current query on the "hero_image" edge.
func (_q *PostQuery) QueryHeroImage() *PhotoQuery {
...
// QueryRelatedPosts chains the current query on the "related_posts" edge.
func (_q *PostQuery) QueryRelatedPosts() *PostQuery {
...
func (_q *PostQuery) QuerySection() *SectionQuery {
...
func (_q *PostQuery) QueryWriters() *AuthorQuery {
...
func (_q *PostQuery) QueryCreatedBy() *UserQuery {
...
func (_q *PostQuery) Clone() *PostQuery {
	...
	return &PostQuery{
		...
		withHeroImage:    _q.withHeroImage.Clone(),
		withRelatedPosts: _q.withRelatedPosts.Clone(),
		withSection:      _q.withSection.Clone(),
		withTags:         _q.withTags.Clone(),
		withWriters:      _q.withWriters.Clone(),
...
func (_q *PostQuery) WithCategories(opts ...func(*CategoryQuery)) *PostQuery {
	query := (&CategoryClient{config: _q.config}).Query()
...
// WithHeroImage tells the query-builder to eager-load the nodes that are connected to
// the "hero_image" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *PostQuery) WithHeroImage(opts ...func(*PhotoQuery)) *PostQuery {
	query := (&PhotoClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithRelatedPosts tells the query-builder to eager-load the nodes that are connected to
// the "related_posts" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *PostQuery) WithRelatedPosts(opts ...func(*PostQuery)) *PostQuery {
	query := (&PostClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withRelatedPosts = query
	return _q
}
...
func (_q *PostQuery) WithSection(opts ...func(*SectionQuery)) *PostQuery {
	query := (&SectionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PostQuery) WithWriters(opts ...func(*AuthorQuery)) *PostQuery {
	query := (&AuthorClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withWriters = query
	return _q
}

// WithCreatedBy tells the query-builder to eager-load the nodes that are connected to
// the "created_by" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *PostQuery) WithCreatedBy(opts ...func(*UserQuery)) *PostQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PostQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Post, error) {
	var (
		...
		loadedTypes = [7]bool{
			...
			_q.withHeroImage != nil,
			_q.withRelatedPosts != nil,
			_q.withSection != nil,
			_q.withTags != nil,
			_q.withWriters != nil,
	...
	if _q.withHeroImage != nil || _q.withSection != nil || _q.withCreatedBy != nil {
		withFKs = true
	}
	if withFKs {
	...
	if query := _q.withHeroImage; query != nil {
		if err := _q.loadHeroImage(ctx, query, nodes, nil,
			func(n *Post, e *Photo) { n.Edges.HeroImage = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withRelatedPosts; query != nil {
		if err := _q.loadRelatedPosts(ctx, query, nodes,
			func(n *Post) { n.Edges.RelatedPosts = []*Post{} },
			func(n *Post, e *Post) { n.Edges.RelatedPosts = append(n.Edges.RelatedPosts, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withSection; query != nil {
		if err := _q.loadSection(ctx, query, nodes, nil,
			func(n *Post, e *Section) { n.Edges.Section = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withWriters; query != nil {
		if err := _q.loadWriters(ctx, query, nodes,
			func(n *Post) { n.Edges.Writers = []*Author{} },
			func(n *Post, e *Author) { n.Edges.Writers = append(n.Edges.Writers, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withCreatedBy; query != nil {
		if err := _q.loadCreatedBy(ctx, query, nodes, nil,
			func(n *Post, e *User) { n.Edges.CreatedBy = e }); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedCategories {
		if err := _q.loadCategories(ctx, query, nodes,
			func(n *Post) { n.appendNamedCategories(name) },
			func(n *Post, e *Category) { n.appendNamedCategories(name, e) }); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedRelatedPosts {
		if err := _q.loadRelatedPosts(ctx, query, nodes,
			func(n *Post) { n.appendNamedRelatedPosts(name) },
			func(n *Post, e *Post) { n.appendNamedRelatedPosts(name, e) }); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedTags {
		if err := _q.loadTags(ctx, query, nodes,
			func(n *Post) { n.appendNamedTags(name) },
			func(n *Post, e *Tag) { n.appendNamedTags(name, e) }); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedWriters {
		if err := _q.loadWriters(ctx, query, nodes,
			func(n *Post) { n.appendNamedWriters(name) },
			func(n *Post, e *Author) { n.appendNamedWriters(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *PostQuery) loadCategories(ctx context.Context, query *CategoryQuery, nodes []*Post, init func(*Post), assign func(*Post, *Category)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(category.FieldID), joinT.C(post.CategoriesPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(post.CategoriesPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(post.CategoriesPrimaryKey[0]))
...
func (_q *PostQuery) loadHeroImage(ctx context.Context, query *PhotoQuery, nodes []*Post, init func(*Post), assign func(*Post, *Photo)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Post)
	for i := range nodes {
		if nodes[i].post_hero_image == nil {
			continue
		}
		fk := *nodes[i].post_hero_image
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "post_hero_image" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (_q *PostQuery) loadRelatedPosts(ctx context.Context, query *PostQuery, nodes []*Post, init func(*Post), assign func(*Post, *Post)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int]*Post)
	nids := make(map[int]map[*Post]struct{})
	for i, node := range nodes {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(post.RelatedPostsTable)
		s.Join(joinT).On(s.C(post.FieldID), joinT.C(post.RelatedPostsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(post.RelatedPostsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(post.RelatedPostsPrimaryKey[0]))
		s.AppendSelect(columns...)
		s.SetDistinct(false)
	})
	if err := query.prepareQuery(ctx); err != nil {
	...
	for _, n := range neighbors {
		nodes, ok := nids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected "related_posts" node returned %v`, n.ID)
		}
		for kn := range nodes {
			assign(kn, n)
		}
...
func (_q *PostQuery) loadSection(ctx context.Context, query *SectionQuery, nodes []*Post, init func(*Post), assign func(*Post, *Section)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Post)
	for i := range nodes {
		if nodes[i].post_section == nil {
			continue
		}
		fk := *nodes[i].post_section
		if _, ok := nodeids[fk]; !ok {
			ids = append(ids, fk)
		}
		nodeids[fk] = append(nodeids[fk], nodes[i])
	...
	for _, n := range neighbors {
		nodes, ok := nodeids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "post_section" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (_q *PostQuery) loadWriters(ctx context.Context, query *AuthorQuery, nodes []*Post, init func(*Post), assign func(*Post, *Author)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int]*Post)
	nids := make(map[int]map[*Post]struct{})
	for i, node := range nodes {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(post.WritersTable)
		s.Join(joinT).On(s.C(author.FieldID), joinT.C(post.WritersPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(post.WritersPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(post.WritersPrimaryKey[0]))
		s.AppendSelect(columns...)
		s.SetDistinct(false)
	})
	if err := query.prepareQuery(ctx); err != nil {
	...
	for _, n := range neighbors {
		nodes, ok := nids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected "writers" node returned %v`, n.ID)
		}
		for kn := range nodes {
			assign(kn, n)
		}
...
func (_q *PostQuery) loadCreatedBy(ctx context.Context, query *UserQuery, nodes []*Post, init func(*Post), assign func(*Post, *User)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Post)
	for i := range nodes {
		if nodes[i].post_created_by == nil {
			continue
		}
		fk := *nodes[i].post_created_by
		if _, ok := nodeids[fk]; !ok {
			ids = append(ids, fk)
		}
		nodeids[fk] = append(nodeids[fk], nodes[i])
	...
	for _, n := range neighbors {
		nodes, ok := nodeids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "post_created_by" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (_q *PostQuery) WithNamedCategories(name string, opts ...func(*CategoryQuery)) *PostQuery {
	query := (&CategoryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithNamedRelatedPosts tells the query-builder to eager-load the nodes that are connected to the "related_posts"
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *PostQuery) WithNamedRelatedPosts(name string, opts ...func(*PostQuery)) *PostQuery {
	query := (&PostClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if _q.withNamedRelatedPosts == nil {
		_q.withNamedRelatedPosts = make(map[string]*PostQuery)
	}
	_q.withNamedRelatedPosts[name] = query
	return _q
}

// WithNamedTags tells the query-builder to eager-load the nodes that are connected to the "tags"
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *PostQuery) WithNamedTags(name string, opts ...func(*TagQuery)) *PostQuery {
	query := (&TagClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithNamedWriters tells the query-builder to eager-load the nodes that are connected to the "writers"
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *PostQuery) WithNamedWriters(name string, opts ...func(*AuthorQuery)) *PostQuery {
	query := (&AuthorClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if _q.withNamedWriters == nil {
		_q.withNamedWriters = make(map[string]*AuthorQuery)
	}
	_q.withNamedWriters[name] = query
	return _q
}
