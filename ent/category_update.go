...
func (_u *CategoryUpdate) SetSectionID(id int) *CategoryUpdate {
...
func (_u *CategoryUpdate) SetNillableSectionID(id *int) *CategoryUpdate {
	if id != nil {
...
func (_u *CategoryUpdate) SetSection(v *Section) *CategoryUpdate {
	return _u.SetSectionID(v.ID)
}

// AddPostIDs adds the "posts" edge to the Post entity by IDs.
func (_u *CategoryUpdate) AddPostIDs(ids ...int) *CategoryUpdate {
...
func (_u *CategoryUpdate) ClearSection() *CategoryUpdate {
...
func (_u *CategoryUpdate) RemovePostIDs(ids ...int) *CategoryUpdate {
...
func (_u *CategoryUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.SectionCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   category.SectionTable,
			Columns: []string{category.SectionColumn},
			Bidi:    false,
...
// SetSectionID sets the "section" edge to the Section entity by ID.
func (_u *CategoryUpdateOne) SetSectionID(id int) *CategoryUpdateOne {
	_u.mutation.SetSectionID(id)
	return _u
}

// SetNillableSectionID sets the "section" edge to the Section entity by ID if the given value is not nil.
func (_u *CategoryUpdateOne) SetNillableSectionID(id *int) *CategoryUpdateOne {
	if id != nil {
		_u = _u.SetSectionID(*id)
	}
	return _u
...
// SetSection sets the "section" edge to the Section entity.
func (_u *CategoryUpdateOne) SetSection(v *Section) *CategoryUpdateOne {
	return _u.SetSectionID(v.ID)
}

// AddPostIDs adds the "posts" edge to the Post entity by IDs.
func (_u *CategoryUpdateOne) AddPostIDs(ids ...int) *CategoryUpdateOne {
	_u.mutation.AddPostIDs(ids...)
	return _u
}
...
// ClearSection clears the "section" edge to the Section entity.
func (_u *CategoryUpdateOne) ClearSection() *CategoryUpdateOne {
	_u.mutation.ClearSection()
	return _u
}
...
// RemovePostIDs removes the "posts" edge to Post entities by IDs.
func (_u *CategoryUpdateOne) RemovePostIDs(ids ...int) *CategoryUpdateOne {
	_u.mutation.RemovePostIDs(ids...)
	return _u
}
