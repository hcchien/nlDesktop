...
func (*Tag) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case tag.FieldBrief, tag.FieldName:
...
func (_m *Tag) NamedPosts(name string) ([]*Post, error) {
...
func (_m *Tag) appendNamedPosts(name string, edges ...*Post) {
	if _m.Edges.namedPosts == nil {
